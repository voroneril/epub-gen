...
(function() {
  var EPub, Q, _, archiver, cheerio, ejs, entities, fs, fsextra, mime, path, removeDiacritics, request, rimraf, uslug, uuid, axios,
    indexOf = [].indexOf;
  ...
  EPub = class EPub {
    ...
    makeCover() {
      ...
      if (typeof this.options.userAgent != "undefined" && this.options.userAgent) {
